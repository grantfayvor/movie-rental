app.controller("CartController", ['$scope', 'CartService', function ($scope, CartService) {
    ...
    $scope.getHotMovies = function () {
        CartService.getHotMovies(function (response) {
    ...
    $scope.updateMovieInCart = function (rowId, index) {
        Pace.restart();
        ...
        console.log(details);
        CartService.updateMovieInCart(details, function (response) {
            $scope.getCartCount();
            $scope.cart.total_price = response.data.total_price;
            $scope.cart = response.data;
            console.log("movie in cart has been updated");
            // console.log(response.data);
        }, function (response) {
            console.log("error occured while updating movie in cart");
        });
    };
...
app.service("CartService", ['APIService', function (APIService) {
    ...
    this.updateMovieInCart = function (details, successHandler, errorHandler) {
