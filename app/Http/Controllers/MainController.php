...
class MainController extends Controller
{
    ...
    {
        return view('admin/add-movie', ['username' => Auth::user() ? Auth::user()->name : null]);
    }
    ...
    {
        return view('admin/movie', ['username' => Auth::user() ? Auth::user()->name : null]);
    }

    public function viewMoviesAsList()
    {
        return view('admin/movie-list', ['username' => Auth::user() ? Auth::user()->name : null]);
    }
    ...
    public function viewMovieImage(Request $request)
    {
