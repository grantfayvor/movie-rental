...
use App\Repositories\CartMovieDetailsRepository;
...
class CartService
{
    ...
    /**
     * @param array $movieDetails contains id, name, qty, price, options->imageLocation
     * @return \Gloudemans\Shoppingcart\CartItem
     */
    public function addToCart(array $movieDetails)
    {
        return $this->cart->add($movieDetails);
    }
