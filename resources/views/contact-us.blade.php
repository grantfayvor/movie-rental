...
<head>
    ...
    <title>Contact | Movie-Booking</title>
            ...
            <div class="row">
                <div class="col-sm-8">
                    <div class="contact-form">
                        ...
                        <form id="main-contact-form" action="/contact-us" class="contact-form row" name="contact-form" method="post">
                            ...
                            <div class="form-group col-md-6">
				                <input type="email" name="email" value="{{ $email }}" class="form-control" required="required" placeholder="Email">
				            </div>
