...
<head>
    ...
    <title>Checkout | Movie-Booking</title>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            ...
                            <a href="/">
                                <img src="images/home/logo.png" style="height:60px; width:80px;" alt="Movie-Booking" />
                            </a>
                        </div>
        ...
        <div class="container">
            ...
            <div class="table-responsive cart_info">
                <table class="table table-condensed">
                    ...
                    <tbody>
                        <tr data-ng-repeat="movie in cart.data">
                            <td class="cart_movie">
                                <a href="">
                                    <img data-ng-src="<%movie.options.image_location%>" style="height:40px;width:40px;padding:0px 0px 0px;" alt="movie image">
                                </a>
                            </td>
                            ...
                            <td class="cart_price">
                                <p>₦
                                    <span data-ng-bind="movie.price"></span>
                                </p>
                            </td>
                            <td class="cart_quantity">
                                <div class="cart_quantity_button">
                                    <input id="quantity_value<%$index%>" class="cart_quantity_input" style="width:20%!important" type="number" data-ng-model="movieToUpdate.qty"
                                        name="quantity" value="<% movie.qty %>" data-ng-change="updateMovieInCart(movie.rowId, $index)"
                                        min="1">
                                </div>
                            </td>
                            <td class="cart_total">
                                <p class="cart_total_price">₦
                                    <span data-ng-bind="movie.price * movie.qty"></span>
                                </p>
                            </td>
                            <td class="cart_delete">
                                <a class="cart_quantity_delete" href="javascript:void(0)" data-ng-click="removeFromCart(movie.rowId)">
